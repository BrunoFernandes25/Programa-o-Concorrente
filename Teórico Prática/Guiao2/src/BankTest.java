...
public class BankTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        long startTime = System.currentTimeMillis(); // Registro do tempo inicial
        int ACCS = 10;
        int ITERS = 100000;
        ...
        long endTime = System.currentTimeMillis(); // Registro do tempo final
        long totalTime = endTime - startTime; // Calcular o tempo total de execução
